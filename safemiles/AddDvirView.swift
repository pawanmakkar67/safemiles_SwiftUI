...
struct AddDvirView: View {
    ...
    private var inspectionDetailsSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            // Odometer
            customTextField(title: "Odometer (miles) + offset \(viewModel.vehicleOffset)", placeholder: "Enter odometer in miles", text: $viewModel.odometer, keyboardType: .decimalPad, isError: viewModel.isOdometerError)
