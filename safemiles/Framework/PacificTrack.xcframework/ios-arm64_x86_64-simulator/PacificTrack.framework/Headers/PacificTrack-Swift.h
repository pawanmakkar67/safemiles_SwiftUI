...
SWIFT_ENUM_FWD_DECL(NSInteger, ResponseStatus)
...
SWIFT_CLASS("_TtC12PacificTrack7DtcData")
@interface DtcData : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtCC12PacificTrack7DtcData5Fault")
...
SWIFT_CLASS("_TtCC12PacificTrack7DtcData4OBD2")
@interface OBD2 : Fault
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end

SWIFT_CLASS("_TtCC12PacificTrack7DtcData5J1708")
@interface J1708 : Fault
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end

SWIFT_CLASS("_TtCC12PacificTrack7DtcData5J1939")
@interface J1939 : Fault
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end

SWIFT_CLASS("_TtCC12PacificTrack7DtcData12NotAvailable")
@interface NotAvailable : Fault
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
/// <em>max</em>: <code>65536</code>,
/// <em>default</em>: 0
@property (nonatomic, readonly) NSUInteger hsi;
...
/// Human-readable description of the event frame
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
/// Speed in km/h as reported by GPS.
...
/// Human-readable description of the geolocation parameters
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, SPNEventMode)
...
/// <em>max</em>: <code>65536</code>,
/// <em>default</em>: 0
  SystemVariableHosSequenceIndex = 16,
/// HSI Increment Mode
/// <code>3</code> means <em>Always</em>,
/// <code>2</code> means <em>Increment when BLE is connected</em>,
/// <code>1</code> means <em>Increment when BLE is disconnected</em>,
/// <code>0</code> means <em>Never</em>,
/// <em>default</em>: <code>1</code>
  SystemVariableHsiIncrementMode = 17,
/// Extension
/// A quote-less string of less than 128 bytes
  SystemVariableExtension = 18,
};
...
SWIFT_ENUM_FWD_DECL(NSInteger, TrackerFirmwareType)
@class NSData;
...
SWIFT_ENUM_FWD_DECL(NSInteger, TrackerServiceState)
@class VirtualDashboardDataUnwrapped;
@protocol TrackerServiceDelegate;
@class CBPeripheral;
SWIFT_ENUM_FWD_DECL(NSInteger, TrackerServiceError)
SWIFT_ENUM_FWD_DECL(NSInteger, TrackerUpgradeError)
...
/// note:
/// <code>devMode</code> property is the main source of truth for selecting environment mode.
/// WebService environment is set according to <code>devMode</code> at initialization.
...
@optional
/// TrackerService value for RSSI signal strength
/// <ul>
///   <li>
///     Parameters:
///   </li>
...
///   </li>
///   <li>
///     value: <code>NSNumber</code>
///   </li>
/// </ul>
- (void)trackerService:(TrackerService * _Nonnull)trackerService didReceiveRSSI:(NSNumber * _Nonnull)value;
@end
...
/// Indicates if the <code>dtcData</code> is present
@property (nonatomic) BOOL dtcDataPresent;
/// Parsed DTC data from the deprecated DTC segment when present
@property (nonatomic, strong) DtcData * _Nullable dtcData;
...
/// Indicates if the <code>engineRPMHighRes</code> is present
@property (nonatomic) BOOL engineRPMHighResPresent;
/// Engine RPM HightRes
@property (nonatomic) double engineRPMHighRes;
/// Indicates if the <code>intakePressure</code> is present
@property (nonatomic) BOOL intakePressurePresent;
/// Intake Pressure - 0 to 510 kPa
@property (nonatomic) double intakePressure;
...
/// Indicates if the <code>retarderPercent</code> is present
@property (nonatomic) BOOL retarderPercentPresent;
/// Retarder Percent from brake info
@property (nonatomic) double retarderPercent;
/// Indicates if the <code>brakePedal</code> is present
@property (nonatomic) BOOL brakePedalPresent;
/// Brake pedal state from brake info
@property (nonatomic) uint8_t brakePedal;
