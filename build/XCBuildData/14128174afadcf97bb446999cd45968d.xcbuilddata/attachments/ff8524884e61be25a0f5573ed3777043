...
extension Foundation.Bundle {
    ...
    static let module: Bundle = {
        let bundleName = "IQTextInputViewNotification_IQTextInputViewNotification"
        ...
        fatalError("unable to find bundle named IQTextInputViewNotification_IQTextInputViewNotification")
    }()
}