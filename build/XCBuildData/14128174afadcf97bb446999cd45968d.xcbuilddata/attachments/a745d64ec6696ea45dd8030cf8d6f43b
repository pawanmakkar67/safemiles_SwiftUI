...
extension Foundation.Bundle {
    ...
    static let module: Bundle = {
        let bundleName = "IQKeyboardToolbarManager_IQKeyboardToolbarManager"
        ...
        fatalError("unable to find bundle named IQKeyboardToolbarManager_IQKeyboardToolbarManager")
    }()
}